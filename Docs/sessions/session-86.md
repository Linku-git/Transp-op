...
## Tasks
- [ ] Create `backend/app/services/payment/stripe_client.py` with Stripe integration
- [ ] Implement Stripe customer and subscription management
- [ ] Implement Stripe webhook handling (payment success, failure, subscription updates)
- [ ] Implement webhook signature verification for security
- [ ] Integrate with Navigo API for Ile-de-France transit pass verification
- [ ] Implement Navigo pass status checking and validation
- [ ] Integrate with Edenred for NAT benefits management
- [ ] Integrate with Swile for NAT benefits management
- [ ] Create API endpoints for payment status management
- [ ] Create API endpoints for transport pass management
- [ ] Handle payment and pass data securely (PCI compliance considerations)
...
- `backend/app/api/routes/transport_pass.py`
...
## Tests
- [ ] Test Stripe client creates customers and subscriptions correctly
- [ ] Test Stripe webhook handling for payment_intent.succeeded event
- [ ] Test Stripe webhook handling for payment_intent.payment_failed event
- [ ] Test Stripe webhook handling for subscription update events
- [ ] Test Stripe webhook signature verification rejects invalid signatures
- [ ] Test Navigo API pass verification with mocked API
- [ ] Test Navigo pass status checking returns correct status
- [ ] Test Edenred NAT benefits integration with mocked API
- [ ] Test Swile NAT benefits integration with mocked API
- [ ] Test payment status API endpoints return correct data
- [ ] Test transport pass management API endpoints
