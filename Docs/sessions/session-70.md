...
## Tasks
- [ ] Create ContentFeedScreen with tabs: All, News, Training, Safety, Surveys
- [ ] Implement card list with title, snippet, type badge, date, media thumbnail, completion indicator, and "New" badge
- [ ] Add pull-to-refresh functionality
- [ ] Add offline indicator for cached content
- [ ] Create ContentDetailScreen with full article view, rich text rendering, image gallery, and video support
- [ ] Implement "Mark as Read" auto-trigger on scroll completion
...
## Tests
- [ ] Test ContentFeedScreen renders card list with all required fields
- [ ] Test tab filtering switches between content types correctly
- [ ] Test pull-to-refresh triggers data reload
- [ ] Test offline indicator displays when cached content is shown
- [ ] Test ContentDetailScreen renders full article with rich text and media
- [ ] Test "Mark as Read" triggers on scroll completion
